...
export default function NewPlace({navigation}) {
  ...
  const [placeType, setPlaceType] = useState('historical sites');
      ...
      <Modal
        ...
        <View
          ...
          <TouchableOpacity
            ...
            onPress={() => selectPlaceType('historical sites')}>
          ...
          <TouchableOpacity
            style={{borderBottomColor: 'green', borderBottomWidth: 0.2}}
            onPress={() => selectPlaceType('nature reserves')}>
            <Text style={{color: 'green', padding: 15, textAlign: 'center'}}>
              Nature Reserves
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={{borderBottomColor: 'green', borderBottomWidth: 0.2}}
            onPress={() => selectPlaceType('family-friendly activities')}>
            <Text style={{color: 'green', padding: 15, textAlign: 'center'}}>
